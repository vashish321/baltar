...
const departments = [
  {
    ...
    subsidiaries: [
      { label: 'Toronto Media Inc.', href: '/technologies/toronto-media-inc' },
      { label: 'Frontend Media Inc.', href: '/technologies/frontend-media' },
      { label: 'Transac Inc.', href: '/finance/transac' },
    ],
  },
  {
    name: 'Baltar Hospitality',
    subsidiaries: [
      { label: 'Savour & Sip', href: '/hospitality/savour-and-sip' },
    ],
  },
  {
    name: 'Baltar Fashion',
    subsidiaries: [
      { label: 'VR', href: '/fashion/vr' },
    ],
  },
  {
    name: 'Baltar Consultancy',
    subsidiaries: [
      { label: 'Baltar Consulting', href: '/consulting/baltar-engineering' },
      { label: 'Baltar International', href: '/consulting/baltar-international' },
    ],
  },
];
